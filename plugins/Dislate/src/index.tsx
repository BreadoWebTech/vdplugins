...
export default {
    onLoad: () => {
        // prevent
        if (!["581573474296791211", "757982547861962752", "548821619661864962", "1034473954636726334"].find(k => k === findByProps("getCurrentUser").getCurrentUser()?.id)) return removePlugin(plugin.id)
